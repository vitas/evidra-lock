...
export function Landing({ onGetStarted }: LandingProps) {
  ...
  return (
    <div className="landing" ref={landingRef}>
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="hero-sub">
            Evidra is a kill-switch for AI agents managing infrastructure. AI can
            suggest. Evidra decides. Destructive changes are blocked unless
            proven safe. Every decision is recorded to a tamper-proof evidence
            chain.
          </p>
          <p className="hero-tagline">
            Adopt AI in infrastructure — without giving it the keys to
            production.
          </p>
      ...
      {/* Not OPA */}
      <section className="diff-section reveal">
        <div className="container">
          <h2>Not a replacement for OPA</h2>
          <p className="diff-sub">
            Admission controllers run at deploy time, inside the cluster. Evidra
            runs before execution — across kubectl, terraform, helm, argocd.
            Especially in AI-driven workflows.
          </p>
        </div>
      </section>
