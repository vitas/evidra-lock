...
- [ ] Start MCP in ops profile:
  - [ ] `EVIDRA_PROFILE=ops EVIDRA_PACKS_DIR=./packs/_core/ops EVIDRA_POLICY_PATH=./policy/policy.rego EVIDRA_POLICY_DATA_PATH=./policy/data.json EVIDRA_EVIDENCE_PATH=./data/evidence ./bin/evidra-mcp`
...
- [ ] `./bin/evidra-evidence export --evidence ./data/evidence --out ./audit-pack.tar.gz --policy ./policy/policy.rego --data ./policy/data.json` creates pack containing:
